...
Results-driven **Java Full Stack Developer** with hands-on experience architecting scalable web applications using **Spring Boot** and **React.js**. Proven ability to optimize data retrieval, engineer robust **Role-Based Access Control (RBAC)** systems, and deliver production-ready REST APIs and microservices.

- 🔭 Currently working as a **Java Full Stack Development Intern** at **Java By Kiran, Pune**
- 🎓 B.Tech in Computer Science & Technology — **Shivaji University, Kolhapur** (2021–2025)
...
- Architected a scalable full-stack food ordering platform using Spring Boot backend and React.js frontend
- Implemented microservices architecture for modular, maintainable, and independently deployable services
- Integrated **JWT-based secure authentication** and an automated admin dashboard for real-time order tracking and cart management
...
|------|---------|----------|
| **Java Full Stack Development Intern** | Java By Kiran (The Kiran Academy), Pune | Jun 2025 – Nov 2025 |

**Key Achievements:**
- Developed and maintained backend services using **Java 17** and **Spring Boot**, and frontend with **React.js** and **Tailwind CSS**
- Implemented **Hibernate caching & indexing strategies**, reducing API response time by **15%**
- Integrated **MySQL** for large-scale data management with efficient, optimized SQL queries
- Collaborated in **Agile** cross-functional teams; participated in code reviews following Git best practices
